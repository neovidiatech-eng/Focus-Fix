...
export const Hero = ({
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col items-center justify-center sm:pt-50 pt-20 overflow-hidden bg-slate-50"
    >
      <SubtleGrid color="#00000008" className="opacity-100" />
      <Spotlight
        className="-top-40 inset-s-0 md:inset-s-60 md:-top-20"
      ...
      <ContainerScroll
        titleComponent={
          <div className="flex flex-col items-center">
            <div className="">
              <h1 className="text-3xl  md:text-6xl font-black leading-tight text-slate-900 mb-6 tracking-tighter">
                {t("hero.title1")} <br />
                <span className="gradient-text text-3xl md:text-5xl">
                  {t("hero.title2")}
                </span>
              </h1>
              <p className="md:text-xl text-[15px] text-slate-600 md:mb-10 mb-7 max-w-2xl mx-auto leading-relaxed font-medium">
                {t("hero.description")}
              </p>
            </div>
            <div className="gap-2 md:mb-12 mb-8 grid grid-cols-1 sm:grid-cols-2">
              <motion.div
